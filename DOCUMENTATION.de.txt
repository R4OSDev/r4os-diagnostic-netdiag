...
NETDIAG.R4X ist die Netzwerk-Robustheitsdiagnose.
...
Build:
    ...
    cd Code\System\Diagnostics\NetDiag
    ..\..\..\DevTools\Zig\zig.exe build

Ergebnis:

    Code\System\Diagnostics\NetDiag\zig-out\NETDIAG.R4X

Contract:
- Build-Profil: `Zig/R4XStart`
- R4XStart-Entry: `netdiag_main`
- App-Klasse: `console`
- R4L-Imports: `R4SYS`, `R4NET`
- Zielpfad im Image: `C:\R4OS\SOFTWARE\TERMINAL\DIAG\NETDIAG.R4X`
